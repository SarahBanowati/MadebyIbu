<?php
$menu = [
    ["nama" => "Strawberry Cake", "harga" => "Rp 12.000", "gambar" => "strawbery.jpeg", "kategori" => "cake"],
    ["nama" => "Tiramisu Cake", "harga" => "Rp 22.000", "gambar" => "tiramisu.jpeg", "kategori" => "cake"],
    ["nama" => "Matcha Cake", "harga" => "Rp 15.000", "gambar" => "matcha.jpeg", "kategori" => "cake"],
    ["nama" => "Red Velvet Cookies", "harga" => "Rp 8.000", "gambar" => "redvelvet.jpeg", "kategori" => "cookies"],
    ["nama" => "Milk Choco Cookies", "harga" => "Rp 8.000", "gambar" => "milkchoco.jpeg", "kategori" => "cookies"],
    ["nama" => "Lotus Biscoff Cookies", "harga" => "Rp 8.000", "gambar" => "biscoff.jpeg", "kategori" => "cookies"]
];

// Ambil tipe dari URL untuk filter
...
<header style="position: fixed; top: 20px; left: 0; right: 0; display: flex; justify-content: center; z-index: 9999;">
    <nav style="background: rgba(255, 255, 255, 0.98); width: 90%; max-width: 1100px; padding: 12px 30px; border-radius: 50px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
        ...
        <ul style="list-style: none; display: flex; gap: 25px; margin: 0; padding: 0;">
            ...
            <li><a href="index.php#menu" style="text-decoration: none; color: #333; font-weight: 500;">Menu</a></li>
...
<section style="background: linear-gradient(rgba(128,0,0,0.8), rgba(128,0,0,0.8)), url('assets/bakery.jpeg') center/cover no-repeat; text-align: center; color: white;">
    ...
    <div><a href="index.php#menu" style="background: white; color: var(--maroon); padding: 16px 45px; border-radius: 50px; text-decoration: none; font-weight: 700; box-shadow: 0 10px 20px rgba(0,0,0,0.2);">Lihat Menu</a></div>
</section>
...
<section style="background: var(--white); padding: 100px 20px; text-align: center;">
    ...
    <div style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;">
        <a href="index.php?type=cake#menu" style="text-decoration: none; color: inherit;"> 
            <div style="background: #fff5f5; padding: 45px; border-radius: 35px; width: 170px; border: 2px solid <?= ($type_filter == 'cake') ? 'var(--maroon)' : '#eee' ?>; transition: 0.3s;">
        ...
        <a href="index.php?type=cookies#menu" style="text-decoration: none; color: inherit;">
            <div style="background: #fff5f5; padding: 45px; border-radius: 35px; width: 170px; border: 2px solid <?= ($type_filter == 'cookies') ? 'var(--maroon)' : '#eee' ?>; transition: 0.3s;">
...
<section id="menu" style="background: #fdfdfd; padding: 100px 50px;">
    <div style="text-align: center; margin-bottom: 60px;">
        <h2 style="font-family: 'Playfair Display', serif; color: var(--maroon); font-size: 45px; margin-bottom: 10px;">
            Daftar <?= $type_filter ? ucfirst($type_filter) : 'Menu' ?>
        </h2>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 35px; max-width: 1200px; margin: 0 auto;">
        <?php 
        foreach($menu as $m): 
            if ($type_filter !== '' && strtolower($m['kategori']) !== strtolower($type_filter)) {
                continue;
            }
        ?>
...
<section id="booking" style="background: var(--maroon); padding: 100px 20px;">
    <div style="max-width: 700px; margin: auto; background: white; padding: 60px; border-radius: 40px; box-shadow: 0 25px 60px rgba(0,0,0,0.3);">
        ...
        <form action="#" method="POST" style="display: flex; flex-direction: column; gap: 20px;">
            <input type="text" name="nama_lengkap" placeholder="Nama Lengkap" required style="padding: 18px; border-radius: 15px; border: 1px solid #eee; outline: none; font-family: 'Poppins', sans-serif;">
            <input type="tel" name="whatsapp" placeholder="Nomor WhatsApp" required style="padding: 18px; border-radius: 15px; border: 1px solid #eee; outline: none; font-family: 'Poppins', sans-serif;">
            <textarea name="alamat" placeholder="Alamat Pengiriman Lengkap" required style="padding: 18px; border-radius: 15px; border: 1px solid #eee; outline: none; min-height: 100px; resize: none; font-family: 'Poppins', sans-serif;"></textarea>
            ...
            <input type="number" name="jumlah" placeholder="Total Jumlah Pesanan" required style="padding: 18px; border-radius: 15px; border: 1px solid #eee; outline: none; font-family: 'Poppins', sans-serif; margin-top: 10px;">
